...
import { textAreaVariations } from "../constants/textAreaConstants";
import { TextAreaDataIndex, EpidTextAreaSplitted, EpidTextArea, InputMode } from "../types/textAreaTypes";
