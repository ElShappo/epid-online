...
const Logo = () => {
  ...
  return (
    <Button
      ...
      onClick={() => navigate("/")}
    >
      <section className="flex flex-wrap justify-center items-center content-center p-2 gap-1">
        <img src="blue_logo_pixian_ai.png" width={80} height={74} />
        <div>
          <div className="text-3xl">Epid-online</div>
          <i className="max-sm:hidden">
            Эпидемиологические расчеты в Вашем браузере
          </i>
        </div>
      </section>
    </Button>
